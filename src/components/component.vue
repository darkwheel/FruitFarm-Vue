<template>
  <div class="component-steps">
    <h1 class="component-text"><span>Discover Our Process</span></h1>
    <span class="component-text02">
    ...
    <div class="component-container">
      <div class="component-step">
        <div class="component-container01">
          <div class="component-line"></div>
          <div class="component-container02">
            <svg viewBox="0 0 1024 1024" class="component-icon">
              <path
          ...
          <div class="component-line1"></div>
        </div>
        <div class="component-container03">
          <h1 class="component-text05"><span>Ideate</span></h1>
          <span class="component-text07">
      ...
      <div class="component-step1">
        <div class="component-container04">
          <div class="component-line2"></div>
          <div class="component-container05">
            <svg viewBox="0 0 1024 1024" class="component-icon2">
              <path
          ...
          <div class="component-line3"></div>
        </div>
        <div class="component-container06">
          <h1 class="component-text10"><span>Design</span></h1>
          <span class="component-text12">
            <span>Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
            <br />
            <span></span>
          </span>
      ...
      <div class="component-step2">
        <div class="component-container07">
          <div class="component-line4"></div>
          <div class="component-container08">
            <svg viewBox="0 0 1024 1024" class="component-icon4">
              <path d="M576 736l96 96 320-320-320-320-96 96 224 224z"></path>
              <path d="M448 288l-96-96-320 320 320 320 96-96-224-224z"></path>
            </svg>
          </div>
          <div class="component-line5"></div>
        </div>
        <div class="component-container09">
          <h1 class="component-text15"><span>Develop</span></h1>
          <span class="component-text17">
            <span>Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
            <br />
            <span></span>
          </span>
      ...
      <div class="component-step3">
        <div class="component-container10">
          <div class="component-line6"></div>
          <div class="component-container11">
            <svg viewBox="0 0 1024 1024" class="component-icon7">
              <path
          ...
          <div class="component-line7"></div>
        </div>
        <div class="component-container12">
          <h1 class="component-text20"><span>Deploy</span></h1>
          <span class="component-text22">
            <span>Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
            <br />
            <span></span>
          </span>
